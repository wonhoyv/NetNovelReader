...
object SQLHelper {
    ...
    fun getDB(): SQLiteDatabase {
        db ?: synchronized(SQLHelper) {
            db ?: kotlin.run {
                db = NovelSQLHelper(ReaderApplication.appContext!!, dbName, null, 1).writableDatabase
            }
        }
        return db!!
    }
    ...
    class NovelSQLHelper(val context: Context, val name: String, val factory: SQLiteDatabase.CursorFactory?,
                         val version: Int) : SQLiteOpenHelper(context, name, factory, 1) {
